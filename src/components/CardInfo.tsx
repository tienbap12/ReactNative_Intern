      ...
      <View style={styles.infoContainer}>
        <View style={styles.userInfo}>
          <View style={[styles.infoGroup, styles.flexInfo]}>
            ...
            <View style={[styles.infoGroup, {gap: 10}]}>
              <Text style={styles.textInfo}>tienbap12</Text>
          ...
          <View style={[styles.infoGroup, styles.flexInfo]}>
            ...
            <View style={[styles.infoGroup, {gap: 10}]}>
              <Text style={styles.textInfo}>24/09/2001</Text>
              <FontAwesome name="edit" size={20} color="#fff" />
            </View>
          </View>
          <View style={[styles.infoGroup, styles.flexInfo]}>
            ...
            <View style={[styles.infoGroup, {gap: 10}]}>
              <Text style={styles.textInfo}>Binh Thuan</Text>
              <FontAwesome name="edit" size={20} color="#fff" />
            </View>
          </View>
          <View style={[styles.infoGroup, styles.flexInfo]}>
            ...
            <View style={[styles.infoGroup, {gap: 10}]}>
              <Text style={styles.textInfo}>Sai Gon</Text>
              <FontAwesome name="edit" size={20} color="#fff" />
            </View>
          </View>
          <View style={[styles.infoGroup, styles.flexInfo]}>
            ...
            <View style={[styles.infoGroup, {gap: 10}]}>
              <Text style={styles.textInfo}>0903192469</Text>
              <FontAwesome name="edit" size={20} color="#fff" />
            </View>
          </View>
          <View style={[styles.infoGroup, styles.flexInfo]}>
            ...
            <View style={[styles.infoGroup, {gap: 10}]}>
              <Text style={styles.textInfo}>tienbap12@gmail.com</Text>
              <FontAwesome name="edit" size={20} color="#fff" />
            </View>
          </View>
        </View>
        <View
          ...
          <View>
            ...
            />
            <Text style={[styles.textInfo, {fontSize: 18}]}>@tienbap12</Text>
          </View>
          <Image
